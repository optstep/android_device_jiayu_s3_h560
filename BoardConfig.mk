...
# Flags
TARGET_GLOBAL_CFLAGS   += -mfpu=neon -mfloat-abi=softfp -Wno-return-type
TARGET_GLOBAL_CPPFLAGS += -mfpu=neon -mfloat-abi=softfp -Wno-return-type
COMMON_GLOBAL_CFLAGS += -DNO_SECURE_DISCARD -Wno-return-type
COMMON_GLOBAL_CFLAGS += -DDISABLE_HW_ID_MATCH_CHECK -Wno-return-type
